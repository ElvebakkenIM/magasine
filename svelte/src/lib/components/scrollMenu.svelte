...
<div id="skrollMeny" style="{innerWidth <= 775 ? 'bottom: 0;' : 'top: 0;'}" in:fade out:fade>
    ...
    <div class="menyRight" style="padding-top: 12.5px;"> 
        ...
        <div class="dropdown">
            ...
            <a href="/bakka/5-pa-bakka" class="noLink"><div class="dropKnapp skrollUnderKnapp" style="--on: {onfB}">5 på Bakka</div></a>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropKnapp skrollUnderKnapp" style="background-color: #414042; color: gray; cursor: not-allowed">Kontakt</div>
        </div>
